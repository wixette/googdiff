The Diff Match and Patch libraries offer a set of robust algorithms to perform the
operations required for synchronizng plain text.

1. Diff:
   * Compare two blocs of plain text and efficiently return a list of differences.
   * [Diff Demo](https://neil.fraser.name/software/diff_match_patch/demos/diff.html)
2. Match:
   * Find its best fuzzy match in a block of plain text. Weighted for both accuracy and location.
...
* [Support](https://groups.google.com/forum/#!forum/diff-match-patch) - The newsgroup for developers.
...
### Algorithms
This library implements [Myer's diff](https://neil.fraser.name/writing/diff/myers.pdf) which is generally considered to be the best general-purpose diff. A laye of [pre-diff speedups and post-diff cleanups](https://neil.fraser.name/writing/diff/) surround the diff algorithm, improving both performance and output quality.

This library also implementss a [Bitap matching algorithm](https://neil.fraser.name/writing/patch/bitap.ps) at the heart of a [flexible matching and patching strategy](https://neil.fraser.name/writing/patch/).
